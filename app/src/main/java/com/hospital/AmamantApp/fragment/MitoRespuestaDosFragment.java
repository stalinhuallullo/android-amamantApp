 ...
 */
public class MitoRespuestaDosFragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ...
    public MitoRespuestaDosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mito_respuesta_dos, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mp = MediaPlayer.create(getActivity(), R.raw.mito_2);
            mp.prepare();
        } catch (Exception e) {
            //
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_siguiente: {
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.ll_content, new MitoTresFragment())
                        .commit();
                break;
            }
        }
