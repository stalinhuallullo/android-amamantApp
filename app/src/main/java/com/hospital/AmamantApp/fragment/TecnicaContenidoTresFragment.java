 ...
 */
public class TecnicaContenidoTresFragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ...
    public TecnicaContenidoTresFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_tecnica_contenido_tres, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mp = MediaPlayer.create(getActivity(), R.raw.tecnica_audio_3);
            mp.prepare();
        } catch (Exception e) {
            //
        }
