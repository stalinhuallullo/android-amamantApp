 ...
 */
public class MitoCincoFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mito_cinco, container, false);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_informacion:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.ll_content, new MitoRespuestaCincoFragment())
                        .commit();
                break;
        }
    }
