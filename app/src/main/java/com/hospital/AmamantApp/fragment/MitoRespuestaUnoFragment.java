 ...
 */
public class MitoRespuestaUnoFragment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
...
//    FloatingActionButton btn_play;
    ...
    public MitoRespuestaUnoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mito_respuesta_uno, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            mp = MediaPlayer.create(getActivity(), R.raw.mito_1);
            mp.prepare();
        } catch (Exception e) {
            //
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_siguiente: {
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.ll_content, new MitoDosFragment())
                        .commit();
                break;
            }
        }
